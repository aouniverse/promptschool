...
export default function Home() {
  ...
  const [messages, setMessages] = useState([
    { role: "assistant", content: "Hi, I'm Prompt School's AI prompt creator! What would you like the prompt to be about?" }
  ]);
  ...
  return (
    <>
      <Head>
        <title>Prompt School | Learn Prompt Engineering </title>
      ...
      <div className={styles.topnav}>
        <div className={styles.navlogo}>
          <img src="https://chatveda.com/wp-content/uploads/2023/03/PROMPT-SCHOOL1.png" width="200"></img>
        </div>
          ...
          <div className={styles.cloudform}>
            <form onSubmit={handleSubmit}>
              <textarea
                ...
                id="userInput"
                name="userInput"
                placeholder={loading ? "Waiting for response..." : "Your wish is my command!"}
                value={userInput}
